...
# Nodes Free
'''n0 = bds.Node(mass, np.array([0.0, 0.0, 3.98789]), np.zeros(3,), isFixed=False)
n1 = bds.Node(mass, np.array([-0.99671, 0.00127, 3.98333]), np.zeros(3,), isFixed=False)
n2 = bds.Node(mass, np.array([-0.49945, 0.86254, 3.98333]), np.zeros(3,), isFixed=False)
n3 = bds.Node(mass, np.array([0.49945, 0.86254, 3.98333]), np.zeros(3,), isFixed=False)
n4 = bds.Node(mass, np.array([0.99671, 0.00127, 3.98333]), np.zeros(3,), isFixed=False)
n5 = bds.Node(mass, np.array([0.49725, -0.86381, 3.98333]), np.zeros(3,), isFixed=False)
n6 = bds.Node(mass, np.array([-0.49725, -0.86381, 3.98333]), np.zeros(3,), isFixed=False)
n7 = bds.Node(mass, np.array([-0.49919, 0.28821, 3.16264]), np.zeros(3,), isFixed=False)
n8 = bds.Node(mass, np.array([0.49919, 0.28821, 3.16264]), np.zeros(3,), isFixed=False)
n9 = bds.Node(mass, np.array([0.0, -0.57641, 3.16264]), np.zeros(3,), isFixed=False)'''
...
print 'Gradient Norm: %d' % np.linalg.norm(model.calculatePEGradient(x0))
print model.calculatePEGradient(x0)
start = time.time()
